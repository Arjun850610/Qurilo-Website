...
const ToggleButton = ( {text, toggleVisibility} ) => {
  return (
    <button
      className="relative flex items-center group overflow-hidden bg-white border-[1px] border-black group-hover:border-white rounded-full cursor-pointer h-14 px-8 pr-16 justify-around"
